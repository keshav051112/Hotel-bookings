...
const Hero = () => {
  ...
  const onSearch = async(e)=>{
      ...
      await axios.post('/api/user/store-recent-search', {recentSearchedCity: destination},{headers: {Authoization: `Bearer ${await getToken()}`}})

      //add destination to searchedCutues max 3 recent searched cities
